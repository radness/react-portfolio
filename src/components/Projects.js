...
class Projects extends Component {
  ...
  onClick = () => {
    console.log('on click handler implementation');
  };
  ...
  toggleCategories() {
    if (this.state.activeTab === 0) {
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
            ...
            >
              React Project #1
              {/* <Link to="project/callback">Callback</Link> */}
            </CardTitle>
            <CardText>React project description.</CardText>
            <CardActions border>
      ...
      return (
        <div>
          <h1>This is Oracle</h1>
        </div>
      );
    } else if (this.state.activeTab === 5) {
      return (
        <div>
          <h1>This is MS-SQL</h1>
        </div>
      );
    }
  }
